...
DATA_DIR = '/home/ubuntu/CS230/coco'

ANNOTATIONS_TRAIN = [os.path.join(DATA_DIR, 'annotations', item) for item in ['person_keypoints_val2017.json']]
ANNOTATIONS_VAL = os.path.join(DATA_DIR, 'annotations', 'person_keypoints_val2017.json')
IMAGE_DIR_TRAIN = os.path.join(DATA_DIR, 'images/val2017')
...
def train_cli(parser):
    ...
    group.add_argument('--batch-size', default=18, type=int,
                       help='batch size')
